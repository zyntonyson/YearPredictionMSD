...
```{r fig.cap='Regresion Lasso lambda óptima'}
# REGRESION LASSO
#importante la semilla
n = nrow(data)
...
* *SVM*
Se ajuste un modelo *SVM* con kernel lineal para la tarea de clasificación, se presenta  la tabla de confusión. El accuracy es de 
...
Ajustamos a una red neuronal con una sola capa de procesamiento de 15 neuronas, con la salida de clasificación *softmax*. Se presenta 

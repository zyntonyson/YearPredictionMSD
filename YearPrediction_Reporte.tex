...
% Pandoc header
\usepackage{graphicx} \usepackage{amsmath} \usepackage{algorithm} \usepackage{algorithmic} \renewcommand{\figurename}{Figura} \renewcommand{\tablename}{Tabla}
...
% in the abstract
\begin{abstract}
El aleaje es un fénomeno ampliamente estudiado y descrito usando modelos
estocásticos. En este trabajo, a modo de ejercicio se usan técnicas
multivariadas en busca de información de interés relativa al oleaje
\end{abstract}
...
\hypertarget{regresion-ordinaria}{%
\subsubsection{Regresión ordinaria}\label{regresion-ordinaria}}

\hypertarget{regresion-con-contraccion-ridge-y-lasso}{%
\subsubsection{Regresión con contracción Ridge y
Lasso}\label{regresion-con-contraccion-ridge-y-lasso}}
